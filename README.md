...
```bash
git clone https://github.com/sravanibaddam2005-20/SOC-Prediction-in-Spartina-alterniflora.git
...
**Sravani** — [GitHub](https://github.com/sravanibaddam2005-20/SOC-Prediction-in-Spartina-alterniflora.git)
